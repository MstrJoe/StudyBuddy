export function HowItWorksPage() {
  return (
    <>
      ...
      <p>
        This app is created so that students of any online schooling program can find moments where
        they can do homework together.
        <br />
        This might help make it easier to form groups in the class which makes every study more fun
        and easy!
      </p>
      <h4>So, what can you do?</h4>

      <h2>Logged in as a student you can:</h2>
      ...
      <p>
        ...
        Find and join eachother on teams or the system that is being used by your school and join
        and start your study together!
      </p>
      ...
      <br />
      <br />
      <h3>StudyBuddy, Stronger Together!</h3>
    </>
  );
}
